...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.kafkaPublisher;
 ...
 */
public class kafkaPublisherConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "kafkaPublisher test case")
